...
export default function Graph() {
  ...
  useEffect(() => {
    ...
    const createdChart = createChart(container, chartOptions);

    const areaSeries = createdChart.addSeries(AreaSeries, {
      lineColor: "#2962FF",
      topColor: "#2962FF",
    ...
    const handleResize = () => {
      createdChart.applyOptions({ width: container.clientWidth });
    };
